...
namespace StarTools.Collections
{
    /// <summary>
    ...
    public class PriorityQueue<T>
    {
        ...
        public void Push(T value)
        {
            ...
            {
                Array.Resize<T>(ref _heap, Count * 2);
            }
        ...
        public void Pop()
        {
            ...
            if (Count > 0)
            {
                ...
                T x = _heap[Count];        // lift item x out from the last position
                ...
                _heap[Count] = default(T); // don't leak x
            }
        }
        ...
        private int SiftDown(int index)
        {
            ...
            while (leftChild < Count)
            {
                ...
                var bestChild =
                    (rightChild < Count && _comparer.Compare(_heap[rightChild], _heap[leftChild]) < 0) ?
